...
const doctor_finger_webp_1 = __importDefault(require("../assets/doctor-finger.webp"));
function Banner() {
    const navigate = (0, react_router_dom_1.useNavigate)();
    return (<div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
      ...
      <div className='hidden md:block md:w-1/2 lg:w-[370px] relative'>
        <img src={doctor_finger_webp_1.default} alt="" className='w-full absolute bottom-0 right-0 max-w-md'/>
      </div>
    </div>);
}
